...
{
    wp_enqueue_style('wpdevs-style', get_template_directory_uri() . '/style.css', array(),'1.0', 'all');
    wp_enqueue_style('google-fonts', 'https://fonts.googleapis.com/css2?family=Poppins:wght@400;700&display=swap', array(), null);
    wp_enqueue_script('dropdown' , get_template_directory_uri().'/js/dropdown.js', array(), '1.0', true);
    /*A função script recebe o nome do hundle, acessa o directory, armazena no array a dependencia caso seja necessŕio como por exemplo o jquery,
     preciso definir a versão e também infomar onde quero que o js seja carregado, apos definir com a função wp_footer por exemplo eu acabei dizendo
    que true eu quero definir*/
}
